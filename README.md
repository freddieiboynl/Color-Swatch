Why would you ever have to create color swatches again from scratch? Tap on the `color` prop to open the color picker and watch as you get color information automagically ✨
